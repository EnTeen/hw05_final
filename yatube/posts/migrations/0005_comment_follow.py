# Generated by Django 2.2.16 on 2022-04-08 10:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, help_text='Добавьте дату комментария', verbose_name='Дата комментария')),
